...
![01-network-memory-pool.png]/docs/bitcoin/images/01-network-memory-pool.png)
...
![02-node-pool-block.png]/docs/bitcoin/images/02-node-pool-block.png)
...
![03-node-pool-string.png]/docs/bitcoin/images/03-node-pool-string.png)
